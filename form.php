...
<div>
<center><img style="width: 25%; margin-top: 1%;" src="asset/keterangan.png"></center>
</div>
...
<div class="container" style="margin-top: -2.35%;">
  ...
  <div class="row">
    <div class="col col-lg-2" style="margin-left:-6.8%">
       <a href ="marketgds.php" class="btn-2" style="text-decoration: none; color: #FF6600;"> <  Back</a> 
    </div>
...
<br>
          ...
          <div class="col-sm-8">
           ...
           <input name="kapasitas_produksi" id="kapasitas_produksi" style="border-radius: 15px; border-color: #676F73;" type="number" class="form-control"  placeholder="Masukkan Banyak Produksi Per Tahun" required>
          </div>
          <div class="col-sm-4">
           <label>Satuan:</label>
