...
$data="INSERT INTO data_umkm SET nama_umkm='$nama_umkm',alamat='$alamat',komoditas_unggulan='$komoditas_unggulan', material='$material', kapasitas_produksi='$kapasitas_produksi'";
