...
<div class="container">
  ...
  <div class="row">
    <div class="col" style="margin-left:-6.8%">
    ...
    <div class="col-sm-9">
      <h3 >Simulasi Pinjaman Kredit</h3><h8> Kami akan membantu anda dalam memperkirakan kebutuhan dan 
             keuntungan yang anda akan dapatkan <br> jika mengajukan pinjaman kredit kami</h8><br><br>
    </div>
    <div class="col col-lg-2" style="margin-right:-10%">
     <a href ="end.php" class="btn-2" style="text-decoration: none; color: #FF6600;"> Exit   ></a> 
       ...
       <form action="" id="contact" method="post" style="margin-left: 23.2%;width: 50% ;background-color: #F8F8F8; padding: 30px; border-radius: 15px; box-shadow: 0px 5px 5px 5px #D9D9D9;">
...
<a href="simulasikredit.php" type="reset" name="btn-reset" class="btn btn-danger" value="Reset">Reset</a><br><br>
